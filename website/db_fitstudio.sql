...
--
-- Hostiteľ: 127.0.0.1
-- Čas generovania: St 01.Júl 2015, 17:24
...
(4, 0, 1, 0, 0, 'home', 0, 0, 1, 1, NULL, NULL, '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1, 1, NULL, NULL, NULL, NULL, 'ordering', 'ASC', '', NULL, '', 0, 5, NULL, NULL);
...
('sk', 4, 'home', '', 'Welcome to ionize', NULL, '', '', NULL, NULL, NULL, 1);
...
--
ALTER TABLE `notification`
MODIFY `id_notification` int(11) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `page`
--
ALTER TABLE `page`
MODIFY `id_page` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
