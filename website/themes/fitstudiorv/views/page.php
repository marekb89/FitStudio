        ...
        <ion:medias:count type="picture" is_not="0">
          <div class="row">
            ...
            <ion:article:medias type="picture">
              <div class="col-xs-6 col-sm-3 col-md-2 sport <ion:article:name />">                
        ...
        <ion:medias:count type="video" is_not="0">
          <div class="row">
            ...
            <ion:article:medias type="video">
              <div class="col-sm-6 sport <ion:article:name />">
                <div class="video-container">
                  <div class="embed-responsive embed-responsive-16by9">            
                    <iframe src="<ion:media:src />" class="embed-responsive-item"> </iframe>              
                  </div>
                </div>
              </div>
            </ion:article:medias>
